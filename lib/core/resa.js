...
Resa.prototype = {
    ...
    //TODO: Set Params to update only changed attributes
    ...
    start: function (watchSymbols, sockets) {
        ...
        _this.setParams(watchSymbols.params);

        _this.resetFlags();

        _this.output.search_for = watchSymbols;
    ...
    updateWatchListTweet: function (tweet) {
        ...
        this.output.recent_tweets.push({text: tweet.text, date: tweet.created_at});
        //watchList.current_tweet.text=tweet.text;
        //watchList.current_tweet.date=tweet.created_at;
    },

    emptyWatchList: function () {
        this.output.tweets_no = 0;
        this.output.total = 0;
        this.output.recent_tweets = [];
        this.output.symbols = {}
    },
    ...
    stopStreaming: function (stream, sockets) {
        ...
        this.emptyWatchList();
        stream.destroy();
        sockets.sockets.emit('data', this.output);
